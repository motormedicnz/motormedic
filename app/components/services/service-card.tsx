      ...
      <AnimatePresence mode="wait" custom={direction}>
        ...
        >
          ...
          <div className="lg:hidden">
            ...
            <div className="px-4 pt-3 pb-4">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, rgba(220,38,38,0.7), transparent)",
                }}
              />
              ...
              <button
                onClick={() =>
                  onBookNow?.({ id: active.id, title: active.title })
                }
          ...
          <div className="hidden lg:grid lg:grid-cols-[1fr_1.1fr]">
            {/* Left — Gallery fills entire column flush, no padding */}
            <div className="relative overflow-hidden rounded-l-3xl" style={{ minHeight: "420px" }}>
              {/* Gallery: absolute fill so it occupies 100% of the column */}
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(255,255,255,0.03) 0%, rgba(0,0,0,0) 100%)",
              }}
            >
              <div
